...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // Source: https://pt.stackoverflow.com/questions/15058/como-saber-o-tamanho-quantidade-de-propriedades-atributos-de-um-objeto-em-ja
    // Obejct.keys é como se fosse um for/in, percorre o objeto e retorna um array
    // Nesse caso, usar circle.length não daria certo sem o Object.keys pq circle é objeto e não array ;)
